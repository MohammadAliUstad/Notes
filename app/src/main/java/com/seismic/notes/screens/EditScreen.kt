...
fun EditScreen(
    ...
    val note by noteViewModel.getNote(id).collectAsState(initial = null)
    noteViewModel.noteTitleState = note?.title ?: ""
    noteViewModel.noteDescriptionState = note?.description ?: ""
    Scaffold(
        topBar = {
            TopAppBar(
                navigationIcon = {
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                value = noteViewModel.noteTitleState,
            ...
            OutlinedTextField(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(start = 32.dp, top = 8.dp, end = 32.dp, bottom = 16.dp),
                value = noteViewModel.noteDescriptionState,
                ...
                Button(
                    ...
                    onClick = {
                        noteViewModel.updateNote(
                            Note(
                                id = id,
                                title = noteViewModel.noteTitleState,
                                description = noteViewModel.noteDescriptionState
                            )
                        )
